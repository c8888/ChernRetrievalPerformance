...
phaseRetrieveSupportStartHint::usage =
    "phaseRetrieveSupportStartHint[FTXAbs_, StartHintXAbs_, support_, nIterations_, nRepeats_, nHIO_, gamma_] works
    like phaseRetrieveSupport but takes as a starting point the absolute value in the real space."
